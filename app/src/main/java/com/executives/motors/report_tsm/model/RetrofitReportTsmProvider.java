...
import com.executives.motors.report_tsm.api.ReportTsmapi;
...
private ReportTsmapi reportTsmapi;
    ...
    @Override
    public void requestTsmReport(String token, final  ReportTsmCallBack reportTsmCallBack) {
        Call<ReportTsmData>call=reportTsmapi.requestReportTsm(token);
