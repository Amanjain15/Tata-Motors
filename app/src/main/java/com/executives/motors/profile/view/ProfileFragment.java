...
import com.executives.motors.profile.model.RetrofitProfileProvider;
...
import com.executives.motors.profile.presenter.ProfilePresenter;
import com.executives.motors.profile.presenter.ProfilePresenterImpl;
...
//                designation.setFocusableInTouchMode(true);
    ...
    @Override
    public void buttonEnable(boolean show,int id) {
